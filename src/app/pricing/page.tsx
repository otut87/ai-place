        ...
        <section className="mx-auto max-w-5xl px-6 py-16">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2">
            ...
            <div className="rounded-2xl border-2 border-[#191919] bg-white p-7">
              ...
              <div className="mt-2 flex items-baseline gap-2">
                <span className="text-3xl font-bold text-[#191919]">{MONTHLY_PRICE_LABEL}</span>
          ...
          <section className="mt-16">
            ...
            <div className="mt-6 space-y-4">
              <Faq q={`${MONTHLY_PRICE_LABEL}에 포함되는 블로그는 몇 편인가요?`} a="업체 1곳당 월 5편이 자동 발행됩니다. 업체상세 2편 + 비교 1편 + 가이드 1편 + 키워드 1편 로테이션으로, 같은 업체 내에서 내용이 중복되지 않도록 similarity-guard 가 차단합니다. 파일럿 30일 기간에도 동일하게 제공됩니다." />
              <Faq q="파일럿 종료 후 자동 결제되나요?" a={`네, 가입 시 등록한 카드로 30일 후 ${MONTHLY_PRICE_LABEL}이 자동 결제됩니다. 만료 7일 전 리마인드 이메일을 보내드립니다. /owner/billing 에서 언제든 해지 가능합니다.`} />
