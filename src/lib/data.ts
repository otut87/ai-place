...
const places: Place[] = [
  {
    slug: 'yedanpibu',
    name: '예단피부과의원',
    nameEn: 'Yedan Dermatology Clinic',
    city: 'cheonan',
  ...
  },
  {
    slug: 'skinsarang',
    name: '피부사랑피부과',
    nameEn: 'Skin Sarang Dermatology',
    city: 'cheonan',
    category: 'dermatology',
