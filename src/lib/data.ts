...
const categoryFaqsData: Array<{ city: string; category: string; faqs: FAQ[] }> = [
  {
    ...
    faqs: [
      ...
      { question: '천안에서 주말 진료하는 피부과가 있나요?', answer: '네, 현재 등록된 천안 피부과 4곳 모두 토요일 진료를 합니다. 일요일 진료는 현재 없으며, 닥터에버스의원 천안점이 평일 21시까지, 샤인빔클리닉 천안점이 20시30분까지 야간 진료를 운영합니다.' },
      { question: '천안 피부과 진료에 건강보험이 적용되나요?', answer: '아토피, 건선, 여드름 등 질환 치료는 건강보험이 적용됩니다. 보톡스, 필러, 레이저 토닝 등 미용 시술은 비급여(전액 본인부담)입니다.' },
      { question: '천안에서 피부과를 어떻게 선택하면 좋을까요?', answer: '증상에 맞는 전문 분야를 먼저 확인하세요. 리프팅·보톡스·색소는 닥터에버스의원 천안점, 기미·여드름·모공은 클린휴의원, 리프팅·스킨부스터는 샤인빔클리닉 천안점, 난치성여드름·흉터·탈모는 얼라이브피부과 천안아산점이 전문입니다.' },
      { question: '피부과 첫 방문 시 준비할 것이 있나요?', answer: '신분증과 건강보험증을 지참하세요. 현재 복용 중인 약 목록, 피부 증상 사진이 있으면 진료에 도움이 됩니다. 초진 소요 시간은 약 30-40분입니다.' },
      { question: '천안 피부과에서 여드름 치료를 잘하는 곳은 어디인가요?', answer: '일반 여드름·기미·모공은 클린휴의원(동남구 청당동), 난치성 여드름과 흉터는 얼라이브피부과 천안아산점(아산시 탕정면)이 전문입니다. 두 곳 모두 레이저 치료를 병행합니다.' },
    ],
  },
  {
    city: 'cheonan',
...
const comparisonPages: ComparisonPage[] = [
  {
    ...
    faqs: [
      { question: '천안에서 여드름 치료 잘하는 피부과는 어디인가요?', answer: '일반 여드름·기미·모공은 클린휴의원(동남구 청당동)이 전문입니다. 난치성 여드름과 흉터 복원은 얼라이브피부과 천안아산점이 전문 분야입니다.' },
...
const guidePages: GuidePage[] = [
  {
    ...
    summary: '천안 지역 피부과 4곳의 전문 분야, 비용, 진료 시간을 종합 정리한 선택 가이드입니다.',
    sections: [
      {
      ...
      {
        heading: '증상별 추천 피부과',
        content: '천안 피부과는 크게 4가지 전문 분야로 나뉩니다. 리프팅·보톡스·색소는 닥터에버스의원 천안점, 기미·여드름·모공은 클린휴의원, 리프팅·스킨부스터는 샤인빔클리닉 천안점, 난치성여드름·흉터·탈모는 얼라이브피부과 천안아산점이 전문입니다.',
        items: ['리프팅/보톡스/필러/색소 → 닥터에버스의원 천안점 (서북구 불당동)', '기미/여드름/모공/리프팅 → 클린휴의원 (동남구 청당동)', '리프팅/스킨부스터/보톡스/필러 → 샤인빔클리닉 천안점 (동남구 만남로)', '난치성여드름/흉터복원/탈모 → 얼라이브피부과 천안아산점 (아산시 탕정면)'],
        recommendedPlaces: [
      ...
      {
        heading: '진료 시간 비교',
        content: '천안 피부과의 평일 진료 시간은 대부분 09:00-19:00 또는 10:00-20:00입니다. 토요일 진료는 4곳 모두 가능하며, 닥터에버스의원 천안점(평일 21시), 샤인빔클리닉 천안점(20:30), 클린휴의원(금 21시), 얼라이브피부과(수금 20:30)가 야간 진료를 운영합니다.',
        items: ['닥터에버스의원 천안점: 평일 09:00-21:00, 토 09:00-17:00', '클린휴의원: 월 10:00-20:00, 화-목 10:00-19:00, 금 10:00-21:00, 토 10:00-15:00', '샤인빔클리닉 천안점: 월화목금 10:30-20:30, 수 10:00-18:00, 토 10:00-16:00', '얼라이브피부과 천안아산점: 월화 10:00-19:30, 수-금 10:00-20:30, 토 09:00-15:00'],
      },
      {
        heading: '첫 방문 전 준비사항',
    ...
    statistics: [
      { label: '천안 피부과 등록 업체 수', value: '4곳', note: 'AI플레이스 등록 기준 (2026년 4월)' },
      { label: '평균 평점', value: '4.50점', note: '네이버 플레이스 기준, 4개 업체 평균' },
      { label: '토요일 진료 가능 비율', value: '100%', note: '4곳 모두 토요일 진료' },
    ...
    faqs: [
      ...
      { question: '천안에서 주말 진료하는 피부과가 있나요?', answer: '네, AI플레이스에 등록된 천안 피부과 4곳 모두 토요일 진료를 합니다. 일요일 진료는 현재 없습니다.' },
...
const keywordPages: KeywordPage[] = [
  {
    ...
    summary: '천안 지역 여드름 치료 전문 피부과 2곳을 비교하고, 치료 방법·비용·후기를 정리했습니다.',
    relatedPlaceSlugs: ['cleanhue', 'alive-skin'],
    faqs: [
      { question: '천안에서 여드름 치료 잘하는 피부과는 어디인가요?', answer: '클린휴피부과는 여드름·모공 복합 프로그램을 운영하며, 얼라이브피부과 천안아산점은 난치성 여드름 특화 진료를 제공합니다.' },
  ...
  },
  {
    ...
    faqs: [
      { question: '천안에서 보톡스 잘 놓는 피부과는 어디인가요?', answer: '닥터에버스의원 천안점는 보톡스·필러 시술 경력이 풍부하며 야간 21시까지 진료합니다. 샤인빔피부과는 보톡스·스킨부스터 복합 시술을 제공하며 야간 20:30까지 운영합니다.' },
  ...
  },
  {
    ...
    faqs: [
      { question: '천안에서 리프팅 잘하는 피부과는 어디인가요?', answer: '닥터에버스의원 천안점는 리프팅·보톡스 병행 프로그램을 운영하며, 샤인빔피부과는 리프팅·스킨부스터 복합 시술이 강점입니다. 얼라이브피부과는 피부과전문의가 리프팅·흉터 복합 치료를 제공합니다.' },
  ...
  },
  {
    ...
    faqs: [
      { question: '천안에서 기미 치료 잘하는 피부과는 어디인가요?', answer: '클린휴피부과는 기미·색소 치료를 주요 진료 분야로 운영하며, 닥터에버스의원 천안점는 색소·기미 복합 프로그램과 야간 진료를 제공합니다.' },
  ...
  },
  {
    ...
    faqs: [
      { question: '천안에서 야간 진료하는 피부과가 있나요?', answer: '닥터에버스의원 천안점는 평일 21시까지, 샤인빔피부과는 평일 20:30까지, 클린휴피부과는 금요일 21시까지 야간 진료를 운영합니다.' },
    ...
    statistics: [
      ...
      { label: '가장 늦은 야간 진료 시간', value: '21:00', note: '닥터에버스의원 천안점 기준' },
  ...
  },
  {
    ...
    summary: '천안 피부과 4곳의 전문 분야·진료 시간·특징을 한눈에 비교 정리했습니다.',
    relatedPlaceSlugs: ['dr-evers', 'cleanhue', 'shinebeam', 'alive-skin'],
    faqs: [
      { question: '천안에서 피부과 추천해주세요', answer: '닥터에버스의원 천안점(리프팅·보톡스, 야간 21시), 클린휴의원(기미·여드름, 금 야간), 샤인빔클리닉 천안점(리프팅·스킨부스터, 야간 20:30), 얼라이브피부과 천안아산점(난치성여드름·흉터, 전문의)이 있습니다.' },
      ...
      { question: '피부과 전문의가 있는 곳은 어디인가요?', answer: '얼라이브피부과 천안아산점은 피부과 전문의가 상주합니다. 전문의 여부는 건강보험심사평가원에서 확인할 수 있습니다.' },
    ...
    statistics: [
      { label: '천안 피부과 의원 수(조사 대상)', value: '4곳', note: 'AI플레이스 자체 조사 기준 (2026.04)' },
      { label: '피부과 전문의 보유 의원', value: '1곳', note: '얼라이브피부과 천안아산점' },
      { label: '야간 진료 운영 의원', value: '4곳', note: '닥터에버스·샤인빔·클린휴·얼라이브' },
