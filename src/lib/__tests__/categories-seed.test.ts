...
const CATEGORIES = [
  { slug: 'dermatology', name: '피부과', schemaType: 'MedicalClinic' },
  { slug: 'interior', name: '인테리어', schemaType: 'HomeAndConstructionBusiness' },
  { slug: 'webagency', name: '웹에이전시', schemaType: 'ProfessionalService' },
  { slug: 'auto-repair', name: '자동차정비', schemaType: 'AutoRepair' },
  { slug: 'hairsalon', name: '미용실', schemaType: 'HairSalon' },
]
